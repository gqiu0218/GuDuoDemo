package com.singingkungfu.sing.widget.pickerview;
...
import com.singingkungfu.sing.widget.pickerview.lib.WheelView;
import com.singingkungfu.sing.widget.pickerview.listener.CustomListener;
import com.singingkungfu.sing.widget.pickerview.view.BasePickerView;
import com.singingkungfu.sing.widget.pickerview.view.WheelTime;
...
public class TimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    private int Res_Background_Wheel;//滚轮背景颜色
    ...
    public TimePickerView(Builder builder) {
        ...
        this.Res_Background_Wheel = builder.Res_Background_Wheel;
    ...
    public static class Builder {
        ...
        public Builder setBgRes(int Res_Background_Wheel) {
            this.Res_Background_Wheel = Res_Background_Wheel;
            return this;
        }
    ...
    private void initView(Context context) {
        ...
        if (Res_Background_Wheel != 0) {
            timePickerView.setBackgroundResource(Res_Background_Wheel);
        } else {
